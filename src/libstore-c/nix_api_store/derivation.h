...
nix_err nix_derivation_get_outputs(
    ...
    void * userdata,
    void (*callback)(
        nix_c_context * context, void * userdata, const char * output_name, const char * drv_output_id));
...
nix_err nix_derivation_get_input_drv_outputs(
    ...
    void * userdata,
    void (*callback)(
        nix_c_context * context, void * userdata, const char * input_drv_path, const char * output_name));
 ...
 *             dynamic derivation.
 */
nix_err nix_derivation_has_dynamic_inputs(
    nix_c_context * context, const nix_derivation * drv, bool * out_has_dynamic);
