...
public:
    ...
    void updateProgress()
    {
        ...
        auto totalSubstitutions = upfrontSubstitutions > 0 ? upfrontSubstitutions : expectedSubstitutions + doneSubstitutions;
        auto totalDownloadSize = upfrontDownloadSize > 0 ? upfrontDownloadSize : expectedDownloadSize + doneDownloadSize;
